...
function generateClientMaterial(name, type, flags, colour, material_set) {
  ...
  for(let i in types) {
    if((flags & types[i].flag) >= types[i].flag) {
      		if(!(type == "DUST" || type == "SOLID" || type == "INGOT" || type == "GEM")) {
					if(i == "dust" || i == "dustSmall" || i == "dustTiny") {
=======
function addTypeForGenerate(oreprefix, flag, type) {
  types[oreprefix] = {oreprefix: oreprefix, type: type, flag: flag, set: set};
}
function generateClientMaterial(name, type, flags, colour, material_set) {
  for(let i in types) {
    if(types[i].type == "item") {
    if(type == "MARKER") continue;
		
				
    if((flags & types[i].flag) >= types[i].flag) {
      
      		if(!(type == "DUST" || type == "SOLID" || type == "INGOT" || type == "GEM")) {
					if(i == "dust" || i == "smallpiledust" || i == "tinypiledust") {
>>>>>>> b48102bfcf22e626bcd8e40c1421d71a7c6c9a98
						continue;
					}
				}
...
=======
      let alloy_smelterlayer = new IconTransformator.Action.Layering();
      android.util.Log.e("qvaqa", unpreparedTexturesDir + "items-opaque/materialicons/" + material_set.name + "/" + types[i].oreprefix + "_OVERLAY.png");
  alloy_smelterlayer.layer = android.graphics.BitmapFactory.decodeFile(unpreparedTexturesDir + "items-opaque/materialicons/" + material_set.name + "/" + types[i].oreprefix + "_OVERLAY.png");
  let materialbitmap = IconTransformator.transformIcon(android.graphics.BitmapFactory.decodeFile(unpreparedTexturesDir + "items-opaque/materialicons/" + material_set.name + "/" + types[i].oreprefix + ".png"), types[i].set, alloy_smelterlayer);
>>>>>>> b48102bfcf22e626bcd8e40c1421d71a7c6c9a98
  ...
  let copperlayer = new IconTransformator.Action.ColourMultiply(colour);
    let materialbitma = IconTransformator.transformIcon(android.graphics.BitmapFactory.decodeFile(preparedTexturesDir + "items-opaque/" + name + "_" + i + ".png"), material_set[types[i].oreprefix], copperlayer);
    
    let fileo = new java.io.File(preparedTexturesDir + "items-opaque/" + name + "_" + i + "nnn.png");
    let cOutt = new java.io.FileOutputStream(fileo);
  materialbitma.compress(android.graphics.Bitmap.CompressFormat.PNG, 85, cOutt);
  cOutt.flush();
  cOutt.close();
...
function generateClientTool(name, material_set, colour, name2, material_set2, colour2, flags, soft) {
  for(let i in tooltypes) {
    if((flags & tooltypes[i].flag) < tooltypes[i].flag) continue;
...
=======
    ...
    let sss = new java.io.File(dir2 + tooltypes[i].stick + ".png");
    if(!sss.isExists()) {
>>>>>>> b48102bfcf22e626bcd8e40c1421d71a7c6c9a98
...
=======
    let toolbladebitmap = IconTransformator.transformIcon(android.graphics.BitmapFactory.decodeFile(dir + tooltypes[i].head + ".png", material_set, colourlayer));
...
=======
      if(tooltypes[i].stick != "_") {
      let alloy_smelterlayer = new IconTransformator.Action.Layering();
  alloy_smelterlayer.layer = android.graphics.BitmapFactory.decodeFile(dirStick);
  
 let toolbitmap = IconTransformator.transformIcon(android.graphics.BitmapFactory.decodeFile(preparedTexturesDir + "items-opaque/" + name + "_" + tooltypes[i].name + ".png", tooltypes[i].texture_pos, alloy_smelterlayer));
>>>>>>> b48102bfcf22e626bcd8e40c1421d71a7c6c9a98
...
=======
  ...
  {u: 0, v: 7}, {u: 1, v: 7}, {u: 2, v: 7}, {u: 3, v: 7}, {u: 4, v: 7}, {u: 5, v: 7}, {u: 6, v: 7}, {u: 7, v: 7}, {u: 8, v: 7}, {u: 9, v: 7}, {u: 10, v: 7}, {u: 11, v: 7}, {u: 12, v: 7}, {u: 13, v: 7}, {u: 14, v: 7}, {u: 15, v: 7},
  {u: 0, v: 8}, {u: 1, v: 8}, {u: 2, v: 8}, {u: 3, v: 8}, {u: 4, v: 8}, {u: 5, v: 8}, {u: 6, v: 8}, {u: 7, v: 8}, {u: 8, v: 8}, {u: 9, v: 8}, {u: 10, v: 8}, {u: 11, v: 8}, {u: 12, v: 8}, {u: 13, v: 8}, {u: 14, v: 8}, {u: 15, v: 8},
  {u: 0, v: 9}, {u: 1, v: 9}, {u: 2, v: 9}, {u: 3, v: 9}, {u: 4, v: 9}, {u: 5, v: 9}, {u: 6, v: 9}, {u: 7, v: 9}, {u: 8, v: 9}, {u: 9, v: 9}, {u: 10, v: 9}, {u: 11, v:  9}, {u: 12, v: 9}, {u: 13, v: 9}, {u: 14, v: 9},
  {u: 1, v: 10}, {u: 2, v: 10}, {u: 3, v: 10}, {u: 4, v: 10}, {u: 5, v: 10}, {u: 6, v: 10}, {u: 7, v: 10}, {u: 8, v: 10}, {u: 9, v: 10}, {u: 10, v: 10}, {u: 11, v: 10},
  {u: 2, v: 11}, {u: 3, v: 11}, {u: 4, v: 11}, {u: 5, v: 11}, {u: 6, v: 11}, {u: 7, v: 11}, {u: 8, v: 11},
  {u: 3, v: 12}, {u: 4, v: 12}, {u: 5, v: 12},
>>>>>>> b48102bfcf22e626bcd8e40c1421d71a7c6c9a98
  ]);
...
=======
addTypeForGenerate("plate", GENERATE_PLATE, "plate", "item", [
>>>>>>> b48102bfcf22e626bcd8e40c1421d71a7c6c9a98
...
=======
   {u: 3, v: 10}, {u: 4, v: 11}, {u: 5, v: 12}, {u: 10, v: 13}, {u: 11}, {u: 12},
...
addTypeForGenerate("gearGtSmall", GENERATE_SMALL_GEAR, "item", [
  {u: 7}, {u: 8},
  {u: 4}, {u: 5}, {u: 7}, {u: 8}, {u: 10}, {u: 11},
  {u: 4}, {u: 5}, {u: 6}, {u: 7}, {u: 8}, {u: 9}, {u: 10}, {u: 11},
  {u: 5}, {u: 6}, {u: 7}, {u: 8}, {u: 9}, {u: 10},
  {u: 3}, {u: 4}, {u: 5}, {u: 6}, {u: 9}, {u: 10}, {u: 11}, {u: 12},
  {u: 3}, {u: 4}, {u: 5}, {u: 6}, {u: 9}, {u: 10}, {u: 11}, {u: 12},
  {u: 5}, {u: 6}, {u: 7}, {u: 8}, {u: 9}, {u: 10},
  {u: 4}, {u: 5}, {u: 7}, {u: 8}, {u: 10}, {u: 11},
  {u: 4}, {u: 5}, {u: 7}, {u: 8}, {u: 10}, {u: 11},
...
addTypeForGenerate("gearGt", GENERATE_GEAR, "item", [
    {u: 6}, {u: 7}, {u: 8}, {u: 9},
  {u: 3}, {u: 4}, {u: 6}, {u: 7}, {u: 8}, {u: 9}, {u: 11}, {u: 12},
  {u: 2}, {u: 3}, {u: 4}, {u: 5}, {u: 6}, {u: 7}, {u: 8}, {u: 9}, {u: 10}, {u: 11}, {u: 12}, {u: 13},
  {u: 2}, {u: 3}, {u: 4}, {u: 5}, {u: 6}, {u: 7}, {u: 8}, {u: 9}, {u: 10}, {u: 11}, {u: 12}, {u: 13}
  {u: 3}, {u: 4}, {u: 5}, {u: 6}, {u: 7}, {u: 8}, {u: 9}, {u: 10}, {u: 11}, {u: 12},
  {u: 1}, {u: 2}, {u: 3}, {u: 4}, {u: 5}, {u: 6}, {u: 9}, {u: 10}, {u: 11}, {u: 12}, {u: 13}, {u: 14},
   {u: 1}, {u: 2}, {u: 3}, {u: 4}, {u: 5}, {u: 10}, {u: 11}, {u: 12}, {u: 13}, {u: 14},
    {u: 1}, {u: 2}, {u: 3}, {u: 4}, {u: 5}, {u: 10}, {u: 11}, {u: 12}, {u: 13}, {u: 14},
     {1}, {2}, {3}, {4}, {5}, {6}, {9}, {10}, {11}, {12}, {13}, {14},
   {u: 3}, {u: 4}, {u: 5}, {u: 6}, {u: 7}, {u: 8}, {u: 9}, {u: 10}, {u: 11}, {u: 12},
    {u: 2}, {u: 3}, {u: 4}, {u: 5}, {u: 6}, {u: 7}, {u: 8}, {u: 9}, {u: 10}, {u: 11}, {u: 12}, {u: 13},
    {u: 2}, {u: 3}, {u: 4}, {u: 5}, {u: 6}, {u: 7}, {u: 8}, {u: 9}, {u: 10}, {11}, {12}, {13},
    {u: 3}, {u: 4}, {u: 6}, {u: 7}, {u: 8}, {u: 9}, {u: 11}, {u: 12},
    {u: 6}, {u: 7}, {u: 8}, {u: 9},
  ]);
addTypeForGenerate("ring", GENERATE_RING, "item", [
...
addTypeForGenerate("gem", 0, "ingot");
addTypeForGenerate("lens", GENERATE_LENSE, "item", [
  {u: 6}, {u: 7}, {u: 8}, {u: 9},
  {u: 4}, {u: 5}, {u: 6}, {u: 7}, {u: 8}, {u: 9}, {u: 10}, {u: 11},
  {u: 3}, {u: 4}, {u: 5}, {u: 6}, {u: 7}, {u: 8}, {u: 9}, {u: 10}, {u: 11}, {u: 12},
...
addTypeForGenerate("crushed", GENERATE_ORE, "item", [
  {u: 6}, {u: 9},
  {u: 4}, {u: 5}, {u: 6}, {u: 7}, {u: 8}, {u: 9}, {u: 10},
  {u: 3}, {u: 5}, {u: 7}, {u: 9}, {u: 11}, {u: 12},
   {u: 2}, {u: 4}, {u: 6}, {u: 7}, {u: 8}, {u: 11}, {u: 12}, {u: 13},
   {u: 2}, {u: 3}, {u: 4}, {u: 5}, {u: 7}, {u: 8}, {u: 9}, {u: 10}, {u: 11}, {u: 13},
    {u: 1}, {u: 2}, {u: 4}, {u: 5}, {u: 6}, {u: 8}, {u: 9}, {u: 11}, {u: 12}, {u: 13},
    {u: 1}, {u: 3}, {u: 4}, {u: 6}, {u: 7}, {u: 10}, {u: 12}, {u: 13}, {u: 14},
     {u: 2}, {u: 3}, {u: 5}, {u: 6}, {u: 8}, {u: 9}, {u: 10}, {u: 11}, {u: 12}, {u: 13}, {u: 14},
      {u: 1}, {u: 2}, {u: 4}, {u: 5}, {u: 8}, {u: 9}, {u: 11}, {u: 13},
       {u: 2}, {u: 3}, {u: 5}, {u: 6}, {u: 7}, {u: 8}, {u: 9}, {u: 10}, {u: 11}, {u: 12},
       {u: 4}, {u: 5}, {u: 7}, {u: 9}, {u: 11}, {u: 12},
    {u: 5}, {u: 6}, {u: 8}, {u: 9}, {u: 10},
  ]);
addTypeForGenerate("crushedPurified", GENERATE_ORE, "item", [
  {u: 6}, {u: 7}, {u: 8},
  {u: 4}, {u: 5}, {u: 7}, {u: 8}, {u: 9}, {u: 11},
  {u: 4}, {u: 5}, {u: 6}, {u: 8}, {u: 10}, {u: 11}, {u: 12},
   {u: 2}, {u: 3}, {u: 4}, {u: 6}, {u: 7}, {u: 9}, {u: 10}, {u: 12},
   
   {u: 2}, {u: 4}, {u: 5}, {u: 7}, {u: 8}, {u: 9}, {u: 11}, {u: 12}, {u: 13},
   
    {u: 1}, {u: 2}, {u: 3}, {u: 5}, {u: 6}, {u: 7}, {u: 9}, {u: 10} {u: 11}, {u: 12}, {u: 13}, {u: 14},
    {u: 3}, {u: 4}, {u: 5}, {u: 7}, {u: 8}, {u: 10}, {u: 11}, {u: 12}, {u: 13},
    
     {u: 2}, {u: 3}, {u: 5}, {u: 6}, {u: 8}, {u: 9}, {u: 11}, {u: 14},
     
      {u: 1}, {u: 2}, {u: 3}, {u: 5}, {u: 7}, {u: 8}, {u: 9}, {u: 10}, {u: 11}, {u: 12}, {u: 14},
      
       {u: 2}, {u: 4}, {u: 5}, {u: 7}, {u: 8}, {u: 9}, {u: 10}, {u: 11}, {u: 12}, {u: 13},
       {u: 4}, {u: 6}, {u: 7}, {u: 8}, {u: 11}, {u: 12},
    {u: 5}, {u: 6}, {u: 7}, {u: 9}, {u: 10},
  ]);
addTypeForGenerate("crushedCentrifuged", GENERATE_ORE, "item", [
    {u: 5}, {u: 6}, {u: 7}, {u: 8}, {u: 9},
   ...
   {u: 1}, {u: 2}, {u: 3}, {u: 5}, {u: 7}, {8}, {u: 9}, {u: 10}, {u: 11}, {u: 12}, {u: 14},
   
   {u: 2}, {3}, {5}, {u: 7}, {8}, {9}, {10}, {u: 11}, {u: 12}, {u: 13},
   
   {u: 4}, {u: 5}, {u: 7}, {u: 8}, {u: 9}, {u: 10}, {u: 11}, {u: 12},
   
   {u: 5}, {u: 7}, {u: 8}, {u: 9}, {u: 10},
  ]);
>>>>>>> b48102bfcf22e626bcd8e40c1421d71a7c6c9a98
...
=======
/*addTypeForGenerate("block", 0, "block");
addTypeForGenerate("block", GENERATE_FRAME, "frame_box");*/
>>>>>>> b48102bfcf22e626bcd8e40c1421d71a7c6c9a98

generateClientMaterial("aluminium", "INGOT", EXT2_METAL | GENERATE_SMALL_GEAR | GENERATE_ORE | GENERATE_RING | GENERATE_FRAME, 0x80C8F0, IconTransformator.UV.DULL);
generateClientMaterial("americium", "INGOT", STD_METAL | GENERATE_ROD | GENERATE_LONG_ROD, 0xC8C8C8, IconTransformator.UV.METALLIC);
generateClientMaterial("antimony", "INGOT", EXT_METAL | MORTAR_GRINDABLE, 0xDCDCC8, IconTransformator.UV.SHINY);
...
generateClientMaterial("beryllium", "INGOT", STD_METAL | GENERATE_ORE, 0x64B464, IconTransformator.UV.METALLIC);
...
generateClientMaterial("cobalt", "INGOT", GENERATE_ORE | STD_METAL, 0x2929BC, IconTransformator.UV.METALLIC);
generateClientMaterial("copper", "INGOT", EXT2_METAL | GENERATE_ORE | MORTAR_GRINDABLE | GENERATE_DENSE, 0xFFAAAB, IconTransformator.UV.SHINY);
generateClientMaterial("chlorine", "FLUID",  STATE_GAS, 0xFF8000, IconTransformator.UV.FLUID);
generateClientMaterial("chrome", "INGOT",  EXT2_METAL | GENERATE_RING | GENERATE_ROTOR, 0xFF8000, IconTransformator.UV.FLUID);
generateClientMaterial("gallium", "INGOT", GENERATE_PLATE, 0xFFFF00, IconTransformator.UV.SHINY);
generateClientMaterial("gold", "INGOT", EXT2_METAL | GENERATE_ORE | MORTAR_GRINDABLE | EXCLUDE_BLOCK_CRAFTING_BY_HAND_RECIPES, 0xFFFF00, IconTransformator.UV.SHINY);
generateClientMaterial("fluorine", "FLUID", STATE_GAS, 0xFFFFAA, IconTransformator.UV.FLUID);
generateClientMaterial("iridium", "INGOT", GENERATE_ORE | EXT2_METAL | GENERATE_ORE | GENERATE_RING | GENERATE_ROTOR, 0xFFFFFF, IconTransformator.UV.DULL);
generateClientMaterial("iron", "INGOT", EXT2_METAL | GENERATE_ORE | MORTAR_GRINDABLE | GENERATE_RING | GENERATE_DENSE | GENERATE_FRAME | GENERATE_LONG_ROD | GENERATE_PLASMA | EXCLUDE_BLOCK_CRAFTING_BY_HAND_RECIPES, 0xAAAAAA, IconTransformator.UV.METALLIC);
generateClientMaterial("lead", "INGOT", EXT2_METAL | GENERATE_ORE | MORTAR_GRINDABLE | GENERATE_DENSE, 0x8C648C, IconTransformator.UV.DULL);
generateClientMaterial("magnesium", "INGOT", STD_METAL | GENERATE_ORE, 0xFFBBBB, IconTransformator.UV.METALLIC);
generateClientMaterial("manganese", "INGOT", GENERATE_FOIL, 0xEEEEEE, IconTransformator.UV.DULL);
generateClientMaterial("lithium", "INGOT", STD_METAL | GENERATE_ORE, 0xCBCBCB, IconTransformator.UV.DULL);
...
generateClientMaterial("neodymium", "INGOT", STD_METAL | GENERATE_ROD | GENERATE_ORE, 0x777777, IconTransformator.UV.METALLIC);
generateClientMaterial("nickel", "INGOT", STD_METAL | GENERATE_ORE | MORTAR_GRINDABLE | GENERATE_PLASMA, 0xAAAAFF, IconTransformator.UV.METALLIC);
generateClientMaterial("niobium", "INGOT", STD_METAL, 0xAAAAFF, IconTransformator.UV.METALLIC);
generateClientMaterial("nitrogen", "FLUID", STATE_GAS | GENERATE_PLASMA, 0x90AAEE, IconTransformator.UV.FLUID);
generateClientMaterial("oxygen", "FLUID", STATE_GAS | GENERATE_PLASMA, 0x90AAEE, IconTransformator.UV.FLUID);
generateClientMaterial("hydrogen", "FLUID", STATE_GAS, 0x00FFAA, IconTransformator.UV.FLUID);
generateClientMaterial("palladium", "INGOT", EXT2_METAL | GENERATE_ORE | GENERATE_FLUID_BLOCK, 0xCED0DD, IconTransformator.UV.METALLIC);
generateClientMaterial("phosphorus", "DUST", GENERATE_ORE, 0xC8C800, IconTransformator.UV.DULL);
generateClientMaterial("platinum", "INGOT", EXT2_METAL | GENERATE_ORE | GENERATE_FLUID_BLOCK, 0xFFFF99, IconTransformator.UV.SHINY);
generateClientMaterial("potassium", "INGOT", EXT_METAL, 0xFFFF99, IconTransformator.UV.METALLIC);
generateClientMaterial("titanium", "INGOT", EXT2_METAL | MORTAR_GRINDABLE, 0xDCDCFF, IconTransformator.UV.SHINY);
generateClientMaterial("silver", "INGOT", EXT2_METAL | GENERATE_ORE | MORTAR_GRINDABLE, 0xDCDCFF, IconTransformator.UV.SHINY);
generateClientMaterial("silicon", "INGOT", EXT2_METAL | GENERATE_ORE | MORTAR_GRINDABLE, 0xDCDCFF, IconTransformator.UV.SHINY);
generateClientMaterial("sodium", "INGOT", STD_METAL,  0x000096, IconTransformator.UV.METALLIC);
generateClientMaterial("sulfur", "DUST", NO_SMASHING | NO_SMELTING | FLAMMABLE | GENERATE_ORE, 0xC8C800, IconTransformator.UV.DULL);
generateClientMaterial("tantalum", "INGOT", EXT2_METAL | MORTAR_GRINDABLE | GENERATE_RING, 0xDCDCDC, IconTransformator.UV.DULL);
generateClientMaterial("tin", "INGOT", EXT2_METAL | MORTAR_GRINDABLE | GENERATE_RING | GENERATE_ROTOR | GENERATE_ORE, 0xDCDCDC, IconTransformator.UV.DULL);
generateClientMaterial("thorium", "INGOT", STD_METAL | GENERATE_ORE, 0x001E00, IconTransformator.UV.SHINY);
generateClientMaterial("tungsten", "INGOT", EXT2_METAL, 0x001E00, IconTransformator.UV.METALLIC);
generateClientMaterial("uranium", "INGOT", STD_METAL | GENERATE_ORE, 0x32F032, IconTransformator.UV.METALLIC);
generateClientMaterial("uranium235", "INGOT", STD_METAL | GENERATE_ORE | GENERATE_ROD, 0x32F032, IconTransformator.UV.METALLIC);
generateClientMaterial("vanadium", "INGOT", STD_METAL, 0x323232, IconTransformator.UV.METALLIC);
generateClientMaterial("zinc", "INGOT", STD_METAL | GENERATE_ORE | MORTAR_GRINDABLE | GENERATE_FOIL, 0xFAF0F0, IconTransformator.UV.METALLIC);
...
generateClientMaterial("amber", "GEM", STD_GEM | NO_SMASHING | NO_SMELTING | HIGH_SIFTER_OUTPUT,  0xBD4949, IconTransformator.UV.RUBY);
...
generateClientMaterial("blue_topaz", "GEM", STD_GEM | NO_SMASHING | NO_SMELTING | HIGH_SIFTER_OUTPUT, 0x0000FF, IconTransformator.UV.GEM_HORIZONTAL);
generateClientMaterial("bronze", "INGOT", EXT2_METAL | MORTAR_GRINDABLE | GENERATE_RING | GENERATE_ROTOR | GENERATE_FRAME | GENERATE_LONG_ROD, 0xFF8000, IconTransformator.UV.METALLIC);
generateClientMaterial("brown_limonite", "DUST", GENERATE_ORE, 0xC86400, IconTransformator.UV.METALLIC);
generateClientMaterial("certus_quartz", "GEM", STD_SOLID | NO_SMELTING | CRYSTALLISABLE | GENERATE_ORE, 0xD2D2E6, IconTransformator.UV.QUARTZ);
generateClientMaterial("coal", "GEM", GENERATE_ORE | FLAMMABLE | NO_SMELTING | NO_SMASHING | MORTAR_GRINDABLE | EXCLUDE_BLOCK_CRAFTING_BY_HAND_RECIPES, 0x464646, IconTransformator.UV.ROUGH);
...
generateClientMaterial("chalcopyrite", "DIST", GENERATE_ORE, 0xA07828, IconTransformator.UV.DULL);
...
generateClientMaterial("diamond", "GEM", GENERATE_ROD | GENERATE_BOLT_SCREW | GENERATE_LENSE | GENERATE_GEAR | NO_SMASHING | NO_SMELTING | FLAMMABLE | HIGH_SIFTER_OUTPUT | GENERATE_ORE | DISABLE_DECOMPOSITION | EXCLUDE_BLOCK_CRAFTING_BY_HAND_RECIPES, 0xC8FFFF, IconTransformator.UV.DIAMOND);
generateClientMaterial("emerald", "GEM", STD_GEM | NO_SMASHING | NO_SMELTING | HIGH_SIFTER_OUTPUT | EXCLUDE_BLOCK_CRAFTING_BY_HAND_RECIPES, 0x50FF50, IconTransformator.UV.EMERALD);
generateClientMaterial("ender_pearl", "GEM", GENERATE_PLATE | GENERATE_LENSE | NO_SMASHING | NO_SMELTING, 0x50FF50, IconTransformator.UV.GEM_VERTICAL);
...
generateClientMaterial("glowstone", "DUST", NO_SMASHING | SMELT_INTO_FLUID | GENERATE_PLATE | EXCLUDE_PLATE_COMPRESSOR_RECIPE, 0xFFFF00, IconTransformator.UV.SHINY);
generateClientMaterial("graphite", "INGOT", GENERATE_PLATE | GENERATE_ORE | NO_SMELTING | FLAMMABLE, 0x808080, IconTransformator.UV.DULL);
generateClientMaterial("green_sapphire", "GEM", GENERATE_ORE | NO_SMASHING | NO_SMELTING | HIGH_SIFTER_OUTPUT | GENERATE_LENSE, 0x64C882, IconTransformator.UV.GEM_VERTICAL);
...
generateClientMaterial("gunpowder", "DUST", FLAMMABLE | EXPLOSIVE | NO_SMELTING | NO_SMASHING, 0x808080, IconTransformator.UV.SAND);
generateClientMaterial("quartzite", "GEM", NO_SMELTING | CRYSTALLISABLE | GENERATE_ORE, 0xD2E6D2, IconTransformator.UV.QUARTZ);
generateClientMaterial("ilmenite", "DUST", GENERATE_ORE,  0x463732, IconTransformator.UV.METALLIC);
generateClientMaterial("jasper", "GEM", STD_GEM | NO_SMELTING | HIGH_SIFTER_OUTPUT,  0xC85050, IconTransformator.UV.EMERALD);
...
generateClientMaterial("malachite", "DUST", GENERATE_ORE | INDUCTION_SMELTING_LOW_OUTPUT, 0x055F05, IconTransformator.UV.DULL);
generateClientMaterial("molybdenite", "DUST", GENERATE_ORE, 0x191919, IconTransformator.UV.METALLIC);
generateClientMaterial("nether_quartz", "GEM", STD_SOLID | NO_SMELTING | CRYSTALLISABLE | GENERATE_ORE | EXCLUDE_BLOCK_CRAFTING_BY_HAND_RECIPES, 0xE6D2D2, IconTransformator.UV.QUARTZ);
generateClientMaterial("nether_star", "GEM", STD_SOLID | GENERATE_LENSE | NO_SMASHING | NO_SMELTING,  0xFFFFFF, IconTransformator.UV.NETHERSTAR);
generateClientMaterial("pentlandite", "DUST", GENERATE_ORE, 0xFFFF00, IconTransformator.UV.DULL);
generateClientMaterial("phosphate", "DUST", GENERATE_ORE | NO_SMASHING | NO_SMELTING | FLAMMABLE | EXPLOSIVE, 0xA59605, IconTransformator.UV.DULL);
...
generateClientMaterial("silicon_dioxide", "DUST", NO_SMASHING | NO_SMELTING | CRYSTALLISABLE,  0x9C7CA0, IconTransformator.UV.DULL);
...
generateClientMaterial("ruby", "GEM", STD_GEM | NO_SMASHING | NO_SMELTING | HIGH_SIFTER_OUTPUT, 0xBD4949, IconTransformator.UV.RUBY);
generateClientMaterial("fools_ruby", "GEM", STD_GEM | NO_SMASHING | NO_SMELTING | HIGH_SIFTER_OUTPUT, 0xBD4949, IconTransformator.UV.RUBY);
generateClientMaterial("rutile", "GEM",  STD_GEM | DISABLE_DECOMPOSITION, 0xD40D5C, IconTransformator.UV.GEM_HORIZONTAL);
generateClientMaterial("sapphire", "GEM", STD_GEM | NO_SMASHING | NO_SMELTING | HIGH_SIFTER_OUTPUT, 0x6464C8, IconTransformator.UV.GEM_HORIZONTAL);
generateClientMaterial("sodalite", "GEM", GENERATE_ORE, 0x1414FF, IconTransformator.UV.LAPIS);
generateClientMaterial("tanzanite", "GEM", EXT_METAL | GENERATE_ORE | NO_SMASHING | NO_SMELTING | HIGH_SIFTER_OUTPUT, 0x4000C8, IconTransformator.UV.GEM_VERTICAL);
generateClientMaterial("topaz", "GEM", STD_GEM | NO_SMASHING | NO_SMELTING | HIGH_SIFTER_OUTPUT, 0xFF8000, IconTransformator.UV.GEM_HORIZONTAL);
generateClientMaterial("steel", "INGOT", EXT2_METAL | MORTAR_GRINDABLE | GENERATE_RING | GENERATE_ROTOR | GENERATE_SMALL_GEAR | GENERATE_DENSE | DISABLE_DECOMPOSITION | GENERATE_FRAME | GENERATE_LONG_ROD, 0x505050, IconTransformator.UV.METALLIC);
...
generateClientMaterial("wroughtiron", "INGOT", EXT2_METAL | MORTAR_GRINDABLE | GENERATE_RING | GENERATE_LONG_ROD | DISABLE_DECOMPOSITION, 0xC8B4B4, IconTransformator.UV.METALLIC);
generateClientMaterial("wulfenite", "DUST", GENERATE_ORE, 0xFF8000, IconTransformator.UV.DULL);
generateClientMaterial("water", "FLUID", NO_RECYCLING | DISABLE_DECOMPOSITION, 0xFF8000, IconTransformator.UV.FLUID);
...
generateClientMaterial("stone", "DUST", MORTAR_GRINDABLE | GENERATE_GEAR | GENERATE_PLATE | NO_SMASHING | NO_RECYCLING, 0xB4FFB4, IconTransformator.UV.ROUGH);
...
generateClientMaterial("charcoal", "GEM", FLAMMABLE | NO_SMELTING | NO_SMASHING | MORTAR_GRINDABLE, 0xC8C800, IconTransformator.UV.LIGNITE);
generateClientMaterial("glass", "GEM", GENERATE_PLATE | GENERATE_LENSE | NO_SMASHING | NO_RECYCLING | SMELT_INTO_FLUID | EXCLUDE_BLOCK_CRAFTING_RECIPES, 0xC8C800, IconTransformator.UV.GLASS);
generateClientMaterial("wheat", "DUST", 0, 0xC8C800, IconTransformator.UV.FINE);
generateClientMaterial("brick", "DUST", EXCLUDE_BLOCK_CRAFTING_RECIPES | DECOMPOSITION_BY_CENTRIFUGING, 0xC8C800, IconTransformator.UV.GLASS);
generateClientMaterial("steam", "FLUID", NO_RECYCLING | GENERATE_FLUID_BLOCK | DISABLE_DECOMPOSITION, 0xC8C800, IconTransformator.UV.FLUID);




generateClientMaterial("amethyst", "GEM", STD_GEM | NO_SMASHING | NO_SMELTING | HIGH_SIFTER_OUTPUT, 0xD232D2, IconTransformator.UV.FLINT);
generateClientMaterial("apatite", "GEM", GENERATE_ORE | NO_SMASHING | NO_SMELTING | CRYSTALLISABLE, 0xC8C8FF, IconTransformator.UV.DIAMOND);
...
generateClientMaterial("blaze", "DUST", NO_SMELTING | SMELT_INTO_FLUID | MORTAR_GRINDABLE | BURNING, 0xFFC800, IconTransformator.UV.DULL);
generateClientMaterial("ender_eye", "GEM", GENERATE_PLATE | GENERATE_LENSE | NO_SMASHING | NO_SMELTING, 0x50FF50, IconTransformator.UV.GEM_VERTICAL);
generateClientMaterial("monazite", "GEM", GENERATE_ORE | NO_SMASHING | NO_SMELTING | CRYSTALLISABLE, 0x324632, IconTransformator.UV.DIAMOND); // ? - lantanoids rateearh
generateClientMaterial("olivine", "GEM", STD_GEM | NO_SMASHING | NO_SMELTING | HIGH_SIFTER_OUTPUT, 0x66FF66, IconTransformator.UV.RUBY);
generateClientMaterial("opal", "GEM", STD_GEM | NO_SMASHING | NO_SMELTING | HIGH_SIFTER_OUTPUT, 0x0000FF, IconTransformator.UV.OPAL);
generateClientMaterial("lapis", "GEM", GENERATE_ORE, 0x4646DC, IconTransformator.UV.LAPIS);
generateClientMaterial("lignite", "GEM", GENERATE_ORE | FLAMMABLE | NO_SMELTING | NO_SMASHING | MORTAR_GRINDABLE, 0x644646, IconTransformator.UV.LIGNITE);
generateClientMaterial("pitchblende", "DUST", GENERATE_ORE, 0xC8D200, IconTransformator.UV.DULL);


generateClientMaterial("red_garnet", "GEM", STD_SOLID | GENERATE_LENSE | NO_SMASHING | NO_SMELTING | HIGH_SIFTER_OUTPUT | GENERATE_ORE, 0xC85050, IconTransformator.UV.RUBY);
generateClientMaterial("redstone", "DUST", GENERATE_ORE, 0xC80000, IconTransformator.UV.ROUGH);

generateClientMaterial("yellow_garnet", "GEM", STD_SOLID | GENERATE_LENSE | NO_SMASHING | NO_SMELTING | HIGH_SIFTER_OUTPUT | GENERATE_ORE, 0xC8C850, IconTransformator.UV.RUBY);
generateClientMaterial("flint", "GEM", NO_SMASHING | MORTAR_GRINDABLE, 0x001E00, IconTransformator.UV.FLINT);
generateClientMaterial("vanadium_magnetite", "DUST", GENERATE_ORE, 0x23233C, IconTransformator.UV.METALLIC);




generateClientMaterial("red_alloy", "INGOT", GENERATE_PLATE | GENERATE_FINE_WIRE, 0xC80000, IconTransformator.UV.DULL);
...
=======
  ...
  {x: 8, y: 4}, {x: 9, y: 4}, {x: 10, y: 4}, {x: 11, y: 4}, {x: 12, y: 4}, {x: 14, y: 4},
  {x: 9, y: 5}, {x: 10, y: 5}, {x: 11, y: 5}, {x: 12, y: 5}, {x: 13, y: 5}, {x: 14, y: 5}, {x: 15, y: 5},
   {x: 10, y: 6}, {x: 11, y: 6}, {x: 12, y: 6}, {x: 13, y: 6}, {x: 14, y: 6},
   {x: 11, y: 6}, {x: 12, y: 6}, {x: 13, y: 6},
   {x: 12, y: 7}, null, "_stick", null]);
addToolTypeGenerate("file", "toolHeadFile", "HANDLE_FILE", 0, [
  {x: 3, y: 1}, 
  ...
