...
//MaterialDictionary.registerMaterial(new Material("nitrate", of(new MaterialStack(MaterialDictionary.dict["aluminium"], 2), new MaterialStack(MaterialDictionary.dict["iron"], 3), new MaterialStack(MaterialDictionary.dict["silicon"], 3), new MaterialStack(MaterialDictionary.dict["oxygen"], 12)), "ANION", GENERATE_ORE));
//MaterialDictionary.registerMaterial(new Material("nitrite", of(new MaterialStack(MaterialDictionary.dict["aluminium"], 2), new MaterialStack(MaterialDictionary.dict["iron"], 3), new MaterialStack(MaterialDictionary.dict["silicon"], 3), new MaterialStack(MaterialDictionary.dict["oxygen"], 12)), "ANION", GENERATE_ORE));
//MaterialDictionary.registerMaterial(new Material("sulfate", of(new MaterialStack(MaterialDictionary.dict["aluminium"], 2), new MaterialStack(MaterialDictionary.dict["iron"], 3), new MaterialStack(MaterialDictionary.dict["silicon"], 3), new MaterialStack(MaterialDictionary.dict["oxygen"], 12)), "ANION", GENERATE_ORE));
//MaterialDictionary.registerMaterial(new Material("sulfite", of(new MaterialStack(MaterialDictionary.dict["aluminium"], 2), new MaterialStack(MaterialDictionary.dict["iron"], 3), new MaterialStack(MaterialDictionary.dict["silicon"], 3), new MaterialStack(MaterialDictionary.dict["oxygen"], 12)), "ANION", GENERATE_ORE));
//MaterialDictionary.registerMaterial(new Material("ammonium", of(new MaterialStack(MaterialDictionary.dict["aluminium"], 2), new MaterialStack(MaterialDictionary.dict["iron"], 3), new MaterialStack(MaterialDictionary.dict["silicon"], 3), new MaterialStack(MaterialDictionary.dict["oxygen"], 12)), "CATION", GENERATE_ORE));
//MaterialDictionary.registerMaterial(new Material("tetramethylammonium", of(new MaterialStack(MaterialDictionary.dict["aluminium"], 2), new MaterialStack(MaterialDictionary.dict["iron"], 3), new MaterialStack(MaterialDictionary.dict["silicon"], 3), new MaterialStack(MaterialDictionary.dict["oxygen"], 12)), "CATION", GENERATE_ORE));
...
MaterialDictionary.registerMaterial(new Material("azurite", of(new MaterialStack(MaterialDictionary.dict["copper"], 3), new MaterialStack(MaterialDictionary.dict["carbon"], 2), new MaterialStack(MaterialDictionary.dict["hydrogen"], 2), new MaterialStack(MaterialDictionary.dict["oxygen"], 8)), "DUST", Flags.pack2(GENERATE_ORE, INDUCTION_SMELTING_LOW_OUTPUT)));
MaterialDictionary.registerMaterial(new Material("tenorite", of(new MaterialStack(MaterialDictionary.dict["copper"], 1), new MaterialStack(MaterialDictionary.dict["oxygen"], 1)), "FINE", GENERATE_ORE));
MaterialDictionary.registerMaterial(new Material("halcosine", of(new MaterialStack(MaterialDictionary.dict["copper"], 2), new MaterialStack(MaterialDictionary.dict["sulfur"], 1)), "FINE", GENERATE_ORE));
MaterialDictionary.registerMaterial(new Material("chrysocolla", of(new MaterialStack(MaterialDictionary.dict["copper"], 2), new MaterialStack(MaterialDictionary.dict["aluminium"], 2), new MaterialStack(MaterialDictionary.dict["hydrogen"], 6), new MaterialStack(MaterialDictionary.dict["Silicon"], 2), new MaterialStack(MaterialDictionary.dict["Oxygen"], 9)), "FINE", GENERATE_ORE));
MaterialDictionary.registerMaterial(new Material("spertiniite", of(new MaterialStack(MaterialDictionary.dict["copper"], 2), new MaterialStack(MaterialDictionary.dict["hydrogen"], 2), new MaterialStack(MaterialDictionary.dict["oxygen"], 2)), "FINE", GENERATE_ORE));
MaterialDictionary.registerMaterial(new Material("cuprite", of(new MaterialStack(MaterialDictionary.dict["copper"], 2), new MaterialStack(MaterialDictionary.dict["oxygen"], 1)), "RUBY", GENERATE_ORE));
...
ToolDictionary.registerMaterial({
	material: MaterialDictionary.dict["_NULL"], material2: MaterialDictionary.dict["_NULL"], durability: 100,
	level: 0,
	miningspeed: 0.5,
	attackdamage: 1,
...
ToolDictionary.registerMaterial({
	material: MaterialDictionary.dict["flint"], material2: MaterialDictionary.dict["copper"], durability: 6400,
	level: 1,
	miningspeed: 2.5,
	attackdamage: 5,
	enchantability: 0, flag: 0
...
ToolDictionary.registerMaterial({
	material: MaterialDictionary.dict["iron"], material2: MaterialDictionary.dict["copper"], durability: 25600,
	level: 2,
	miningspeed: 6,
	attackdamage: 6,
	enchantability: 0, flag: 0
...
ToolDictionary.registerMaterial({
	material: MaterialDictionary.dict["steel"], material2: MaterialDictionary.dict["copper"], durability: 51200,
	level: 2,
	miningspeed: 6,
	attackdamage: 6,
	enchantability: 0, flag: 0
...
ToolDictionary.registerMaterial({
	material: MaterialDictionary.dict["bronze"], material2: MaterialDictionary.dict["copper"], durability: 19200,
	level: 2,
	miningspeed: 6,
	attackdamage: 6,
	enchantability: 0, flag: 0
...
ToolDictionary.registerMaterial({
	material: MaterialDictionary.dict["wrought_iron"], material2: MaterialDictionary.dict["copper"], durability: 38400,
	level: 2,
	miningspeed: 6,
	attackdamage: 6,
	enchantability: 0, flag: 0
...
ToolDictionary.registerMaterial({
	material: MaterialDictionary.dict["diamond"], material2: MaterialDictionary.dict["copper"], durability: 128000,
	level: 3,
	miningspeed: 8,
	attackdamage: 7,
	enchantability: 0, flag: 0
...
Item.registerNameOverrideFunction(ItemID.gtmetatool01, function (item) {
	...
	if (item.extra != undefined) {
		if (item.extra.getString("name") != undefined) {
			return item.extra.getString("name") + LocalizationSystem.translate({lang: "en_US", key: "metaitem.tool." + ToolDictionary.getTypeByData(item.data).name + ".name"});
		} else {
			return "Unknown " + LocalizationSystem.translate({lang: "en_US", key: "metaitem.tool." + ToolDictionary.getTypeByData(item.data).name + ".name"});
		}
	} else {
		return "Unknown " + LocalizationSystem.translate({lang: "en_US", key: "metaitem.tool." + ToolDictionary.getTypeByData(item.data).name + ".name"});
	}
