...
RecipeDictionary.addMachineShaped(["pop", "pip", "pap"], ['o', [{type: "common", id: 29, data: 0}, {type: "common", id: 33, data: 0}], 'p', {type: "pipe_machine", name: "small"}, 'a', {type: "common", id: 145, data: 0}, 'i', {type: "casing", typed: "hull"}], {type: "machine_steam", count: 1, name: "hammer"});
...
RecipeDictionary.addMachineShaped(["ppp", "oio", "ppp"], ['o', [{type: "common", id: 33, data: 0}, {type: "common", id: 29, data: 0}], 'p', {type: "pipe_machine", name: "small"}, 'i', {type: "casing", typed: "hull"}], {type: "machine_steam", count: 1, name: "compressor"});
...
RecipeDictionary.addMachineShaped(["ppp", "fig", "ppp"], ['f', [{type: "common", id: 33, data: 0}, {type: "common", id: 29, data: 0}], 'g', {type: "common", id: 20, data: 0}, 'p', {type: "pipe_machine", name: "small"}, 'i', {type: "casing", typed: "hull"}], {type: "machine_steam", count: 1, name: "extractor"});
RecipeDictionary.addMachineShaped(["fpf", "pip", "gpg"], ['f', {type: "common", id: 264, data: 0}, 'g', [{type: "common", id: 33, data: 0}, {type: "common", id: 29, data: 0}], 'p', {type: "pipe_machine", name: "small"}, 'i', {type: "casing", typed: "hull"}], {type: "machine_steam", count: 1, name: "macerator"});

RecipeDictionary.addMachineShaped(["ppp", "p p", "gig"], ['i', {type: "common", id: 61, data: 0}, 'g', {type: "common", id: 45, data: 0}, 'p', {type: "pipe_machine", name: "small"}, 'i', {type: "common", id: 61, data: 0}], {type: "machine_steam", name: "boiler_coal", count: 1});
...
RecipeDictionary.addShaped(["ppp", "p p", "ppp"], ['p', {type: "material", form: ["plate"], material: MaterialDictionary.dict["bronze"]}],  {type: "casing", typed: "bronze_hull", count: 1});
...
RecipeDictionary.addToolShaped(["wrench", "hammer"], ["p_p", "p p", "p_p"], ['p', {type: "material", form: ["plate"], material: MaterialDictionary.dict["bronze"]}],  {type: "pipe_machine", typed: "bronze", name: "small", count: 6});
RecipeDictionary.addToolShaped(["wrench", "hammer"], ["ppp", "_ _", "ppp"], ['p', {type: "material", form: ["plate"], material: MaterialDictionary.dict["bronze"]}],  {type: "pipe_machine", typed: "bronze", name: "normal", count: 2});
RecipeDictionary.addToolShaped(["hammer", "wrench"], ["p_p", "p p", "p_p"], ['p', {type: "material", form: "plate", material: MaterialDictionary.dict["bronze"]}],  {type: "pipe_machine", typed: "bronze", name: "large", count: 1});

RecipeDictionary.addToolShaped(["wrench", "hammer"], ["p_p", "p p", "p_p"], ['p', {type: "material", form: ["plate"], material: MaterialDictionary.dict["copper"]}],  {type: "pipe_machine", typed: "copper", name: "small", count: 6});
RecipeDictionary.addToolShaped(["wrench", "hammer"], ["ppp", "_ _", "ppp"], ['p', {type: "material", form: ["plate"], material: MaterialDictionary.dict["copper"]}],  {type: "pipe_machine", typed: "copper", name: "normal", count: 2});
RecipeDictionary.addToolShaped(["hammer", "wrench"], ["p_p", "p p", "p_p"], ['p', {type: "material", form: "plate", material: MaterialDictionary.dict["copper"]}],  {type: "pipe_machine", typed: "copper", name: "large", count: 1});

RecipeDictionary.addToolShaped(["wrench", "hammer"], ["p_p", "p p", "p_p"], ['p', {type: "material", form: ["plate"], material: MaterialDictionary.dict["steel"]}],  {type: "pipe_machine", typed: "steel", name: "small", count: 6});
RecipeDictionary.addToolShaped(["wrench", "hammer"], ["ppp", "_ _", "ppp"], ['p', {type: "material", form: ["plate"], material: MaterialDictionary.dict["steel"]}],  {type: "pipe_machine", typed: "steel", name: "normal", count: 2});
RecipeDictionary.addToolShaped(["hammer", "wrench"], ["p_p", "p p", "p_p"], ['p', {type: "material", form: "plate", material: MaterialDictionary.dict["steel"]}],  {type: "pipe_machine", typed: "steel", name: "large", count: 1});
...
Recipes.addShaped({id: 280, count: 2, data: 0}, ["l", "l"], ['l', 5, 1]); //
Recipes.addShaped({id: 280, count: 2, data: 0}, ["l", "l"], ['l', 5, 2]); //
Recipes.addShaped({id: 280, count: 2, data: 0}, ["l", "l"], ['l', 5, 3]); //
Recipes.addShaped({id: 280, count: 2, data: 0}, ["l", "l"], ['l', 5, 4]); //
Recipes.addShaped({id: 280, count: 2, data: 0}, ["l","l"], ['l', 5, 5]); //
